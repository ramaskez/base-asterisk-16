...
COPY includes/test.jason.sh /

# ENV DEBIAN_FRONTEND noninteractive

# COPY includes/asterisk-16.6.1.tar.gz /usr/src

# RUN apt-get update; apt-get install -y net-tools build-essential libedit-dev uuid-dev libxml2-dev file libsqlite3-dev libssl-dev libsrtp0-dev; 
